...
static class SecurityManager
{
    ...
    */
    ...
    public static string setAgentShortSecureId()
    {
        ...
        short_secure_id = DataProtection.protect(short_id);
        if(short_id!=null)
        {
            short_id.Dispose();
        }

        return short_secure_id;
    }
    ...
    public static bool isIdFree(string id, int agent_table_id)
    {
        ...
        if (id == ToolsClass.Definition.COMPUTER_AUTHENTIFICATION_ID_DATABASE)
            return false;
