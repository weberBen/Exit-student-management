...
A noter qu'il faut obligatoirement se connecter avec un identifiant et un mot de passe pour accèder aux onglets de l'application, sauf celui relatif au nom de domaine du serveur SQL.
